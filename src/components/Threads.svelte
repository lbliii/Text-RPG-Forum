...
<section>
  <div class="flex flex-row justify-end my-2">
    <ButtonGroup class="space-x-px">
      <Button size="xs" color="green" on:click={() => openCreateModal = true}> Create Thread</Button>
    </ButtonGroup>
  </div>
...
<Modal bind:open={openCreateModal} title="Create Thread">
  ...
  <Textarea bind:value={newPost.body} id="body" name="body" placeholder="Enter a post body here." class="my-2" />
  {#if $characterStore.length > 0}
    <div> 
