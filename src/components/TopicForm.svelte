...
<form class="my-6 justify-center" on:submit|preventDefault={handleSubmit} >
    <div class="flex flex-col text-sm mb-2">
        ...
        <Textarea type="text" bind:value={topic.description} class="apperance-none shadow-sm border border-gray-200 p-2 focus:outline-none focus:border-gray-500 rounded-lg" id="description" name="description" rows="10" placeholder="Topic Description here."></Textarea>
